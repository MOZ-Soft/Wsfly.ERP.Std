...
{
    /// <summary>
    /// WPF当窗体WindowStyle=”None”时，最大化会覆盖掉任务栏
    /// 通过调用WindowHelper.RepairWindowBehavior(Window)方法注册Win32消息事件，
    /// 以后调用this.WindowState = WindowState.Maximized;就可以解决最大化避免覆盖任务栏的问题了。
    /// </summary>
